...
public class SensorServerInVisualize : MonoBehaviour {
    ...
    void Start () {
        ...
        //Debug.Log (SelectController.topicData.topic);
        topicData = SelectController.topicData;
    }
    ...
    void SetTargetEuler (Euler euler) {
        ...
        float targetHead = euler.head - calibrateEuler.head;
